...
export default function AdminBannerPage() {
  ...
  // Reference untuk mereset input file setelah berhasil upload
  ...
  const handleAddBanner = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Dapatkan Public URL dari gambar yang baru diupload
      ...
      // 3. Simpan data banner ke tabel Database
      ...
      alert('Banner berhasil diunggah dan ditambahkan!');
      ...
      setLinkUrl('');
      setStatus('active');
      if (fileInputRef.current) fileInputRef.current.value = ''; // Reset input file UI
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-black text-gray-900 uppercase">Kelola Ruang Promosi</h1>
        <p className="text-gray-500 mt-2">Tambahkan dan atur banner vertikal yang tampil di halaman utama.</p>
      </div>
          ...
          <form onSubmit={handleAddBanner} className="space-y-4">
            <div>
              ...
              <input 
                ...
                placeholder="Misal: Iklan Baju Lebaran"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Upload Gambar Banner</label>
              <input 
                type="file" 
                accept="image/*"
                ref={fileInputRef}
                ...
                required
              />
              <p className="text-[10px] text-gray-500 mt-1">*Pilih gambar dari komputer/HP kamu.</p>
            </div>
        ...
        <div className="lg:col-span-2">
          {isLoading ? (
            ...
            <div className="text-center py-16 bg-gray-50 border border-dashed border-gray-300 rounded-xl">
              <p className="text-gray-500 font-medium">Belum ada banner iklan.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {banners.map((banner) => (
                <div key={banner.id} className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col">
                  {/* Thumbnail Banner */}
                  <div className="w-full h-48 bg-gray-100 relative group border-b border-gray-200">
                    <img 
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <div className="mt-auto flex gap-2 pt-2 border-t border-gray-100">
                      <button 
                        ...
                        className={`flex-1 text-xs font-bold py-1.5 rounded border transition-colors ${
                      ...
                      <button 
                        ...
                        className="flex-1 text-xs font-bold py-1.5 rounded border border-red-500 text-red-600 hover:bg-red-50 transition-colors"
                      >
                        Hapus
                      </button>
                    </div>
